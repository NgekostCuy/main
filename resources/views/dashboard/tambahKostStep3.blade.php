...
<form action="{{ route('dashboard.submitStep2') }}" method="POST">
    ...
    <div class="mb-4">
        ...
        <div class="flex flex-col">
            ...
            <label><input type="checkbox" name="peraturan_kost[]" value="dilarang merokok"> Dilarang Merokok</label>
            <label><input type="checkbox" name="peraturan_kost[]" value="dilarang bertamu melebihi jam 10 malam"> Dilarang Bertamu Melebihi Jam 10 Malam</label>
        </div>
    </div>
    <div class="mb-4">
