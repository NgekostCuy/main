...
<body>
    <header class="py-5"><a href="/" class=" text-teal-600 font-bold text-2xl ml-10 my-10">KostCuy</a> </header>
    <main class="flex">
    <aside class="pt-4">
        <ul>
        ...
        <div class="py-8 px-10">
            ...
            <div class="py-8 px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach ($list_kost as $kost) <!-- Looping untuk setiap kost -->
                    <div class="flex justify-between flex-col bg-gray-50/5 shadow-lg border rounded-md p-4">
                        <div class="flex gap-5 mb-4">
                            <div class="basis-2/3 ">
                                <p class="text-teal-600 font-semibold mb-3">{{ $kost->nama_kost }}</p> <!-- Menampilkan nama kost -->
                                <p class="font-semibold mb-2">{{ $kost->deskripsi_kost }}</p> <!-- Menampilkan deskripsi kost -->
                            ...
                            <div class="">
                                ...
                                <img src="{{ asset('images/' . $kost->images->first()->image) }}" class="object-cover h-24 md:h-full" alt="{{ $kost->nama_kost }}">
                                @else
                        ...
                        <div class="flex gap-4">
                            ...
                            <a href="{{ url('/edit/' . $kost->id) }}" class="flex-1 bg-teal-600 hover:bg-teal-700 text-white rounded py-2 text-center transition duration-150 ease-in-out">Edit Kost</a>
                        </div>
                    </div>
                    @endforeach
                </div>
