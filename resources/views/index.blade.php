    ...
    <section class="rekomendasi m-5">
        ...
        <div class="overflow-x-auto">
            <div class="flex gap-5">
                <div class="w-full max-w-xs md:max-w-sm bg-white border border-gray-200 rounded-lg shadow inline-block">
                    <a href="detail.html">
                        <img class="p-2 rounded-t-xl" src="img/room-5.jpg" alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        <div class="flex items-center mt-2.5 mb-5">
                            <span class="bg-blue-100 text-blue-800 text-sm font-semibold px-2.5 py-0.5 rounded">Putra</span>
                        ...
                        <a href="detail.html">
                            <h5 class="text-xl font-medium tracking-tight text-gray-900">Kost Taman Asri Lestari Bukit Hijau</h5>
                        </a>
                        <div class="flex items-center justify-between">
                            <span class="text-md font-semibold text-gray-900">Rp.750.000 (perbulan)</span>
                        </div>
                ...
                <div class="w-full max-w-xs md:max-w-sm bg-white border border-gray-200 rounded-lg shadow inline-block">
                    <a href="detail.html">
                        <img class="p-2 rounded-t-xl" src="img/room-6.jpg" alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        <div class="flex items-center mt-2.5 mb-5">
                            <span class="bg-blue-100 text-blue-800 text-sm font-semibold px-2.5 py-0.5 rounded">Putra</span>
                        ...
                        <a href="detail.html">
                            <h5 class="text-xl font-medium tracking-tight text-gray-900">Kost Putra Jaya Permai Sentosa Raya</h5>
                        </a>
                        <div class="flex items-center justify-between">
                            <span class="text-md font-semibold text-gray-900">Rp.750.000 (perbulan)</span>
                        </div>
                ...
                <div class="w-full max-w-xs md:max-w-sm bg-white border border-gray-200 rounded-lg shadow inline-block">
                    <a href="detail.html">
                        <img class="p-2 rounded-t-xl" src="img/room-7.jpg" alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        <div class="flex items-center mt-2.5 mb-5">
                            <span class="bg-blue-100 text-blue-800 text-sm font-semibold px-2.5 py-0.5 rounded">Putra</span>
                        ...
                        <a href="detail.html">
                            <h5 class="text-xl font-medium tracking-tight text-gray-900">Kost Bintang Timur Nusantara Mandiri</h5>
                        </a>
                        <div class="flex items-center justify-between">
                            <span class="text-md font-semibold text-gray-900">Rp.750.000 (perbulan)</span>
                        </div>
                ...
                <div class="w-full max-w-xs md:max-w-sm bg-white border border-gray-200 rounded-lg shadow inline-block">
                    <a href="detail.html">
                        <img class="p-2 rounded-t-xl" src="img/room-8.jpg" alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        <div class="flex items-center mt-2.5 mb-5">
                            <span class="bg-blue-100 text-blue-800 text-sm font-semibold px-2.5 py-0.5 rounded">Putra</span>
                        ...
                        <a href="detail.html">
                            <h5 class="text-xl font-medium tracking-tight text-gray-900">Kost Sentosa Pertiwi Damai Sejahtera</h5>
                        </a>
                        <div class="flex items-center justify-between">
                            <span class="text-md font-semibold text-gray-900">Rp.750.000 (perbulan)</span>
                        </div>
