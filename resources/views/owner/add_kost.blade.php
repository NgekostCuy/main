...
<body>
    ...
    <form action="/submit" method="POST" enctype="multipart/form-data" class="w-full mx-5">
        @csrf
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <textarea id="deskripsi" name="deskripsi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required></textarea>
        </div> 
    
        <div class="mb-6">
            <label for="peraturan" class="block mb-2 text-sm font-medium text-gray-900">Peraturan Kost</label>
            <textarea id="peraturan" name="peraturan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required></textarea>
        </div> 
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="number" id="total_kamar" name="total_kamar" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
            </div>
        </div>
        <div class="mb-6">
            <label for="images" class="block mb-2 text-sm font-medium text-gray-900">Upload Gambar</label>
            <input type="file" id="images" name="images[]" multiple class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
        </div> 
